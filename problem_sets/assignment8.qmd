...
Answer: **They are all named in the format buoy_year, they come from the same repo, and they all have the same na values.The only difference is the year for each file.**
