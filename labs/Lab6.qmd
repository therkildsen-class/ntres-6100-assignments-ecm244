...
The columns should parsed to the following types \* observer: double \* species: character \* date: date \* outcome: character \* size: integer \* ocean: character
...
I was unable to use ocean as a facet wrap like I wanted to because the way the ocean names are spelled is inconsistent. I also couldn't use years as a facet because the data is recorded in individual days.
